...
- The folowing program ran very smooth, by following the given instructions. It ran well on Ripes.me with the output being: 
- (g+h)-(i+j)= -4 
...
- Nobody else worked on this project with me, I did the screenshots, code, and this README file.  
